...
export default function Contato() {
  return (
    <section id="contato" className="relative py-28 lg:py-36 bg-navy">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <p className="text-cream/40 text-xs tracking-widest uppercase mb-1">WhatsApp</p>
                    <a
                      href="https://wa.me/5527995351115?text=Ol%C3%A1%2C%20gostaria%20de%20agendar%20uma%20consulta."
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-cream text-lg font-light hover:text-gold transition-colors"
                    >
                      (27) 99535-1115
                    </a>
                  </div>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    <p className="text-cream/40 text-xs tracking-widest uppercase mb-1">Endereco</p>
                    <p className="text-cream text-lg font-light">
                      R. Alaor de Queiroz Araujo, 296
                    </p>
                    <p className="text-cream/60 font-light">
                      Enseada do Sua, Vitoria &mdash; ES, 29050-245
                    </p>
                  </div>
                </div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 px-10 py-4 bg-gold text-navy font-semibold text-sm tracking-widest uppercase hover:bg-gold-light transition-colors duration-300"
              >
          ...
          <AnimatedSection delay={0.2}>
            <div className="relative aspect-[4/3] overflow-hidden border border-cream/5">
              <iframe
